...
const createUser_1 = require("../_middlewares/stripe/createUser");
...
exports.customerRouter.post('/create', (0, validateSchema_1.validate)(customersModel_1.customerJoiSchema), formatData_1.formatData, createUser_1.createStripeCus, customersController_1.createCustomer);
