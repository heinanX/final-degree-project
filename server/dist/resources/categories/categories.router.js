...
exports.categoryRouter.post("/create", authorize_1.authorize, (0, validate_schema_1.validate)(categories_model_1.catJoiSchema), format_data_1.formatData, categories_controller_1.createCat);
exports.categoryRouter.delete("/:id", authorize_1.authorize, categories_controller_1.deleteCat);
