...
exports.orderRouter.get('/', authorize_1.authorize, orders_controller_1.getOrders);
exports.orderRouter.get('/user-orders/:key', authorize_1.authorize, orders_controller_1.getUserOrders);
exports.orderRouter.get('/:id', orders_controller_1.getOrderById);
...
exports.orderRouter.put('/manage-order/:id', authorize_1.authorize, (0, validate_schema_1.validate)(orders_model_1.markOrderJoiSchema), orders_controller_1.manageOrder);
exports.orderRouter.delete('/delete/:id', authorize_1.authorize, orders_controller_1.deleteOrder);
