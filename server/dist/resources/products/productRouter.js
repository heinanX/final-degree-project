...
const createProduct_1 = require("../_middlewares/stripe/product/createProduct");
const archiveProduct_1 = require("../_middlewares/stripe/product/archiveProduct");
...
exports.productRouter.post('/create', isAdmin_1.isAdmin, (0, validateSchema_1.validate)(productModel_1.productJoiSchema), formatData_1.formatData, createProduct_1.createStripeProduct, productController_1.createProduct);
