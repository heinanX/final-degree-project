...
exports.productRouter.get('/category/:id', product_controller_1.getProductsByCategory);
exports.productRouter.get('/tag/:id', product_controller_1.getProductsByTag);
...
exports.productRouter.post('/edit-product/:id', isAdmin_1.isAdmin, (0, validate_schema_1.validate)(product_model_1.productJoiSchema), format_data_1.formatData, /* updateStripeProduct, */ product_controller_1.editProduct);
