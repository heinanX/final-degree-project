...
exports.customerRouter.post('/edit-customer/:id', format_data_1.formatData, authorize_1.authorize, (0, validate_schema_1.validate)(customers_model_1.updateCustomerJoiSchema), update_customer_1.updateStripeCustomer, customers_controller_1.editCustomer);
exports.customerRouter.delete('/delete/:id', authorize_1.authorize, delete_customer_1.deleteStripeCus, customers_controller_1.deleteCustomer);
