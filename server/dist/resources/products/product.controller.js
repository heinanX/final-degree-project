...
exports.deleteProduct = exports.editProduct = exports.createProduct = exports.getProduct = exports.getProductsByTag = exports.getProductsByCategory = exports.getProducts = void 0;
...
const getProductsByCategory = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const orders = yield product_model_1.ProductModel.find({
...
const getProductsByTag = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const orders = yield product_model_1.ProductModel.find({
