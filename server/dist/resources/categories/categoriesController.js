...
const getCats = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const categories = yield categoriesModel_1.CategoryModel.find();
...
const getCat = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const category = yield categoriesModel_1.CategoryModel.findOne({ _id: req.params.id });
...
const createCat = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!checkCat) {
            const newCategory = yield categoriesModel_1.CategoryModel.create(req.body);
